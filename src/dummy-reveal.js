...
DummyReveal.prototype._addEventListeners = function() {
    var self = this;
    var scrolledSpace = window.innerHeight + window.scrollY;
...
DummyReveal.prototype._checkVisible = function(scrollTop) {
    for (var i = 0; i < this.elements.length; i++) {
        if (this.elements[i].offsetTop < scrollTop && this.elements[i].offsetTop > scrollTop - window.innerHeight -  this.elements[i].element.offsetHeight) {
...
var dr = new DummyReveal({
    selector: 'dummyRevial',
    globalDelay: 100,
    classActive: 'fadeInLeft',
    mobile: false
});
